...
export const t = {
  ...
  hero: {
    ...
    intro: {
      ar: "أبني تقارير مالية دقيقة وتحليلات تكاليف موثوقة تدعم قرارات الإدارة التنفيذية.",
      en: "I build accurate financial reports and trusted cost analysis that empower executive decisions.",
    },
  ...
  skills: {
    ...
    sub: { ar: "أدواتي اليومية في عالم الأرقام", en: "My daily toolkit in the world of numbers" },
    groups: [
      {
        ...
        items: [
          ...
          { ar: "تحليل أداء المشاريع", en: "Project Financial Analysis" },
          { ar: "إعداد القوائم المالية", en: "Financial Statements Preparation" },
          { ar: "إعداد المطالبات المالية", en: "Financial Claims Preparation" },
        ],
      },
      {
        h: { ar: "الحسابات والتسويات", en: "Accounts & Reconciliation" },
        items: [
          { ar: "الحسابات المدينة والدائنة", en: "Accounts Receivable & Payable" },
