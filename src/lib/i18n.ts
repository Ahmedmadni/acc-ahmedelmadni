...
export const t = {
  ...
  library: {
    ...
    searchPlaceholder: { ar: "ابحث عن كورس أو شهادة مهنية…", en: "Search a course or certification…" },
    all: { ar: "الكل", en: "All" },
    levels: {
    ...
    courses: [
      ...
      { id: "fund-3",  ar: "إعداد القوائم المالية", en: "Preparing Financial Statements",            cat: "reporting",      level: "intermediate", lang: "ar", price: "free", lessons: 16, hours: 7,  desc: { ar: "إعداد قائمة الدخل والمركز المالي والتدفقات النقدية وفق أفضل الممارسات.", en: "Income statement, balance sheet, and cash flows by best practice." } },
      { id: "fund-4",  ar: "تحليل القوائم المالية", en: "Financial Statements Analysis",              cat: "reporting",      level: "intermediate", lang: "ar", price: "free", lessons: 14, hours: 6,  desc: { ar: "النسب المالية، التحليل الأفقي والرأسي، ومؤشرات الأداء التنفيذية.", en: "Ratios, horizontal & vertical analysis, executive KPIs." } },
      { id: "cert-ifrs", ar: "المعايير الدولية IFRS", en: "IFRS Standards",                            cat: "certifications", level: "advanced",     lang: "ar", price: "paid", lessons: 32, hours: 22, desc: { ar: "المعايير الدولية لإعداد التقارير المالية بشرح تطبيقي وأمثلة عملية.", en: "International Financial Reporting Standards with applied examples." } },
      { id: "cert-cma",  ar: "شهادة CMA - محاسب إداري معتمد", en: "CMA Certification",                cat: "certifications", level: "advanced",     lang: "ar", price: "paid", lessons: 48, hours: 80, desc: { ar: "تحضير كامل لاختبار CMA – الجزئين الأول والثاني.", en: "Full CMA prep — Parts 1 & 2." } },
      { id: "cert-cpa",  ar: "شهادة CPA - محاسب قانوني", en: "CPA Certification",                     cat: "certifications", level: "advanced",     lang: "ar", price: "paid", lessons: 60, hours: 120,desc: { ar: "أقوى شهادة محاسبية أمريكية – FAR, AUD, REG, BEC.", en: "Top US accounting cert — FAR, AUD, REG, BEC." } },
      { id: "cert-socpa",ar: "شهادة SOCPA السعودية", en: "SOCPA Certification",                        cat: "certifications", level: "advanced",     lang: "ar", price: "paid", lessons: 40, hours: 60, desc: { ar: "زمالة الهيئة السعودية للمحاسبين القانونيين.", en: "Saudi Organization for Chartered & Professional Accountants fellowship." } },
      { id: "rep-mgmt",  ar: "المحاسبة الإدارية", en: "Management Accounting",                          cat: "reporting",      level: "intermediate", lang: "ar", price: "free", lessons: 20, hours: 8,  desc: { ar: "أدوات المحاسبة لخدمة قرار الإدارة وتسعير المنتجات.", en: "Accounting tools that serve management decisions and pricing." } },
      { id: "rep-cost",  ar: "محاسبة التكاليف", en: "Cost Accounting",                                  cat: "reporting",      level: "intermediate", lang: "ar", price: "free", lessons: 22, hours: 9,  desc: { ar: "تكلفة الوحدة، التكاليف المعيارية، وتحليل الانحرافات.", en: "Unit cost, standard costing, and variance analysis." } },
      { id: "aud-1",     ar: "المراجعة والتدقيق", en: "Auditing",                                       cat: "audit",          level: "advanced",     lang: "ar", price: "free", lessons: 18, hours: 10, desc: { ar: "أساليب التدقيق، أدلة الإثبات، وتقرير المراجع الخارجي.", en: "Audit techniques, evidence, and external auditor report." } },
      { id: "tax-1",     ar: "المحاسبة الضريبية", en: "Tax Accounting",                                cat: "tax",            level: "intermediate", lang: "ar", price: "free", lessons: 14, hours: 6,  desc: { ar: "المعالجة المحاسبية للضرائب والإفصاح في القوائم.", en: "Accounting treatment of taxes and disclosure." } },
      { id: "tax-vat",   ar: "ضريبة القيمة المضافة VAT", en: "Value Added Tax (VAT)",                  cat: "tax",            level: "beginner",     lang: "ar", price: "free", lessons: 10, hours: 4,  desc: { ar: "حساب الضريبة، الإقرار الشهري/الربعي، وضوابط زاتكا.", en: "VAT calc, monthly/quarterly filing, ZATCA rules." } },
      { id: "tax-zakat", ar: "الزكاة والضريبة السعودية", en: "Saudi Zakat & Tax",                       cat: "tax",            level: "intermediate", lang: "ar", price: "free", lessons: 12, hours: 5,  desc: { ar: "حساب وعاء الزكاة وضريبة الدخل وفق هيئة الزكاة والضريبة والجمارك.", en: "Zakat base & income tax per ZATCA framework." } },
      { id: "fm-1",      ar: "Financial Modeling", en: "Financial Modeling",                            cat: "reporting",      level: "advanced",     lang: "en", price: "paid", lessons: 28, hours: 18, desc: { ar: "بناء النماذج المالية الاحترافية لتقييم الشركات والمشاريع.", en: "Building pro financial models for valuation & projects." } },
      { id: "sw-excel",  ar: "Excel للمحاسبين", en: "Excel for Accountants",                            cat: "software",       level: "intermediate", lang: "ar", price: "free", lessons: 26, hours: 10, desc: { ar: "Pivot, VLOOKUP, Power Query، النماذج المالية، وأتمتة التقارير.", en: "Pivot, VLOOKUP, Power Query, financial models, report automation." } },
      { id: "sw-acct",   ar: "المحاسبة على البرامج المحاسبية", en: "Accounting Software Mastery",     cat: "software",       level: "intermediate", lang: "ar", price: "free", lessons: 30, hours: 14, desc: { ar: "تشغيل الدورة المحاسبية على Odoo، Daftra، Zoho Books، Dentech وغيرها.", en: "Running cycles on Odoo, Daftra, Zoho Books, Dentech & more." } },
    ],
  },
};
