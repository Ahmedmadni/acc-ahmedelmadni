...
const OUTPUT_ROWS: Row[] = [
  {
    k: "out_standard_sales",
    ar: "المبيعات الخاضعة للضريبة بنسبة 15%",
    en: "Standard-rated sales (15%)",
  },
  {
    k: "out_private_health",
    ar: "مبيعات للمواطنين معفاة (تعليم/صحة خاصة)",
    en: "Citizen exempt sales (private health/education)",
  },
  ...
  {
    k: "out_exempt",
    ar: "مبيعات معفاة (إيجار سكني، خدمات مالية)",
    en: "Exempt sales (residential rent, financial)",
  },
];
...
const INPUT_ROWS: Row[] = [
  {
    k: "in_standard_purchases",
    ar: "المشتريات الخاضعة للضريبة بنسبة 15%",
    en: "Standard-rated purchases (15%)",
  },
  {
    k: "in_imports_paid",
    ar: "واردات مدفوع عنها الضريبة في الجمارك",
    en: "Imports VAT paid at customs",
  },
  {
    k: "in_imports_reverse",
    ar: "واردات خاضعة لآلية الاحتساب العكسي",
    en: "Imports under reverse-charge",
  },
  ...
  return (
    <div>
      ...
      <SectionCard title={t("(أ) المبيعات (ضريبة المخرجات)", "(A) Sales (Output VAT)")}>
        ...
        <TotalRow
          label={t("ضريبة المخرجات (15%)", "Output VAT (15%)")}
      ...
      <SectionCard title={t("(ب) المشتريات (ضريبة المدخلات)", "(B) Purchases (Input VAT)")}>
        ...
        <TotalRow
          label={t("ضريبة المدخلات القابلة للخصم", "Deductible input VAT")}
          value={totals.deductibleInput}
        />
        <TotalRow
          label={t("ضريبة الاحتساب العكسي", "Reverse-charge VAT")}
          value={totals.reverseChargeOutput}
        />
      </SectionCard>
      ...
      <SectionCard title={t("(د) ملخص الإقرار", "(D) Return Summary")}>
        ...
        <TotalRow
          label={t("صافي الضريبة المستحقة", "Net VAT payable")}
          value={totals.netVat}
          highlight
        />
        ...
        <div className="mt-4 rounded-md border border-emerald-400/40 bg-emerald-400/10 p-3">
          <div className="text-[11px] font-bold text-emerald-200">
            {t("سداد - رقم فاتورة ضريبة القيمة المضافة", "SADAD VAT invoice number")}
          </div>
